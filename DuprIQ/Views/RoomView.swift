...
/// One room, its drills. Free drills open; DUPR IQ Pro extra sets show the lock and
/// route to the paywall. A locked room (the worked calculations) locks every row.
struct RoomView: View {
    ...
    var body: some View {
        ...
        .sheet(isPresented: $showPaywall) { PaywallView(source: "dupriq_room_sheet") }
    }
    ...
    private var upsell: some View {
        Button {
            ...
            VStack(spacing: 8) {
                ...
                Text("\(Membership.name) unlocks the extra sets here and in every other room, the worked reads, the Daily Drill, Match Warm-Up, and unlimited generated practice. Everything you already have stays free.")
                    .font(.caption)
                    .foregroundStyle(Theme.inkSecondary)
                    .multilineTextAlignment(.leading)
