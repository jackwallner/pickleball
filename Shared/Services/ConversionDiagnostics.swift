...
/// On-device record of how someone met DUPR IQ Pro before they bought it: which
...
enum ConversionDiagnostics {
    private static let logger = Logger(subsystem: "com.jackwallner.pickleball", category: "Conversion")
    ...
    private static let impressionPrefix = "dupriq_"
